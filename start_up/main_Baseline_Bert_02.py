...
from dataset.sighan13_dataset import Sighan13
from model.baseline_bert_02 import Baseline_Bert_02
    ...
    with open(fp, mode="w", encoding="utf-8") as f:
        ...
        for error, predict, correct in zip(strings_error, strings_predict, strings_correct):
            ...
            examples.append({
                ...
                "predict": predict,
                "correct": correct,
                "is_righty": 1 if predict==correct else 0,
                })
...
if __name__== "__main__":
    ...
    model=Baseline_Bert_02(CFG).to(CFG.device)
